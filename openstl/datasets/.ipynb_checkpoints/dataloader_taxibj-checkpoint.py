...
def load_data(batch_size, val_batch_size, data_root, num_workers=4,
    ...
    X_train, Y_train, X_test, Y_test, X_val, Y_val = dataset['X_train'], dataset[
        'Y_train'], dataset['X_test'], dataset['Y_test'], dataset['X_val'], dataset['Y_val']

    print(X_train.shape[1])
    print(pre_seq_length)
    print(Y_train.shape[1])
    print(aft_seq_length)
    ...
    val_set=TaxibjDataset(X=X_val, Y=Y_val, use_augment=False)
...
if __name__ == '__main__':
    dataloader_train, _, dataloader_test = \
        load_data(batch_size=16,
                  ...
                  data_root='../../data/',
                  num_workers=4,
                  pre_seq_length=10, aft_seq_length=190)
